...
import { useSaveListBoxGroupMasterMutation } from 'src/api/master-data.api';
...
const ConfigGroupFormDialog = ({ open, onClose, onSuccess }: Props) => {
    ...
    const [saveListBoxGroupMaster, { isLoading: isLoadingUpdate }] = useSaveListBoxGroupMasterMutation();
        ...
        try {
            setDialogMessage({
                ...
                onOk: async () => {
                    ...
                    dataResponse = await saveListBoxGroupMaster(data).unwrap();
